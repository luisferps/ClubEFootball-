...
def executar_lote_selado():
    ...
    for item in pend:
        ...
        if estado!="rodando":
            ...
            if estado=="pausando" and not atual.get("corrente"):
                controlar("confirmar_pausa")
            break
    ...
    final=status()
    if final.get("estado_lote")=="pausando" and not final.get("corrente"):
        final=controlar("confirmar_pausa")
