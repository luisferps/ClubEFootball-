...
class InterfaceOtimizadorTest(unittest.TestCase):
    ...
    def test_executavel_portatil_mantem_o_estado_local_da_interface_v42(self):
        ...
        self.assertIn('ExpectedVersion = "\\\"versao_interface\\\": \\"20260901-v42\\\""', launcher)
        self.assertIn('AssemblyFileVersion("1.7.1.0")', launcher)
        self.assertIn('Local\\ClubEfootballOtimizadorLauncherV42', launcher)
