...
class InterfaceOtimizadorTest(unittest.TestCase):
    ...
    def test_executavel_portatil_mantem_o_estado_local_da_interface_v40(self):
        ...
        self.assertIn('ExpectedVersion = "\\\"versao_interface\\\": \\"20260831-v40\\\""', launcher)
    ...
    def test_ponte_privada_v16_e_fechada_por_allowlist(self):
        ...
        self.assertIn("otimizador_portal_local_v3", servidor)
