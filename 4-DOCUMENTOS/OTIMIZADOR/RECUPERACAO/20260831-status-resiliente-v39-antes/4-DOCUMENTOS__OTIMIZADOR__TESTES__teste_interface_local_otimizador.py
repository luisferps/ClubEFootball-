...
class InterfaceOtimizadorTest(unittest.TestCase):
    ...
    def test_status_v5_envia_null_para_o_default_do_contrato(self):
        ...
        self.assertEqual(gateway.chamadas, [
            ("otimizador_producao_status_v5", {"p_lote_id": None}, True, 5),
        ])
    ...
    def test_executavel_portatil_mantem_o_estado_local_da_interface_v38(self):
        ...
        self.assertIn('ExpectedVersion = "\\\"versao_interface\\\": \\"20260831-v38\\\""', launcher)
