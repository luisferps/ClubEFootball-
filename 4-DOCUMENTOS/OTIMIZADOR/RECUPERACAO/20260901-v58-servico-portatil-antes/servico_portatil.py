...
def main() -> int:
    ...
    # A entrega portátil já inclui a fotografia integral fatiada. Nunca
    # refazemos o download da fila em outra máquina por trás do ícone: se a
    # pasta foi copiada incompleta, o worker recusa antes de iniciar uma linha.
    os.environ["CLUBEF_OTIMIZADOR_PACOTE_LOCAL_OBRIGATORIO"] = "1"
