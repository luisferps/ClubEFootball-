# -*- coding: utf-8 -*-
"""Smoke test sem rede da interface local e da fronteira operacional V6."""
...
class InterfaceOtimizadorTest(unittest.TestCase):
    ...
    def test_rotulos_continuam_resolvidos_por_ids_canonicos(self):
        ...
        self.assertIn("otimizador_producao_fila_operacional_v3", SERVIDOR.read_text(encoding="utf-8"))
        ...
        self.assertIn("if(abaAtiva('resultados'))pedidos.push(api('/api/resultados?offset='", js)
    ...
    def test_retoma_falha_de_transporte_so_pelo_contrato_v18(self):
        ...
        self.assertEqual(chamadas, [
            ("preparador", "lote-transporte", True),
            ("worker", "lote-transporte", True),
        ])
        self.assertEqual(servico.gateway.chamadas, [(
            "otimizador_producao_recuperar_falha_transporte_v1",
    ...
    def test_executavel_portatil_mantem_o_estado_local_da_interface_v43(self):
        ...
        self.assertIn('ExpectedVersion = "\\\"versao_interface\\\": \\"20260901-v43\\\""', launcher)
        self.assertIn('AssemblyFileVersion("1.7.2.0")', launcher)
        self.assertIn('Local\\ClubEfootballOtimizadorLauncherV43', launcher)
    ...
    def test_resultados_v14_nao_varrem_as_pendencias(self):
        ...
        self.assertIn("otimizador_producao_fila_operacional_v3", servidor)
