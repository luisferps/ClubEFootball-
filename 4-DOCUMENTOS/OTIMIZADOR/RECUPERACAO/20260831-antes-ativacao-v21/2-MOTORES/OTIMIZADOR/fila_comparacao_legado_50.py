...
MOTOR_VERSAO="v8-clube_novo-v3-teste-legado-50"
...
def contrato_fingerprint():
    # A régua continua V2; a carta agora chega por V3. O selo inclui ambos,
    # impedindo executar uma linha selada com outra versão de entradas.
    pacote={"regua":rpc("otimizador_regua_v2",{}),
            "carta_contrato":"otimizador_entradas_v3"}
