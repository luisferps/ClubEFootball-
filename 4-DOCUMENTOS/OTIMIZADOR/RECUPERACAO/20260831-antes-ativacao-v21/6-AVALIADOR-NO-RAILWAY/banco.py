...
def carta_para_simular(card_id):
    ...
    j = _post('/rest/v1/rpc/otimizador_carta_v3', {'p_card_id': str(card_id)})
    if not j:
        return None
    if j.get('contrato') != 'otimizador_entradas_v3':
        raise BancoIndisponivel('contrato de carta inesperado; esperado otimizador_entradas_v3')
...
def pool_da_funcao(card_id, funcao_id):
    ...
    """
    r = _post('/rest/v1/rpc/otimizador_pool_habilidades_v3',
