...
- [x] executável local do Otimizador criado em `2-MOTORES/OTIMIZADOR/`: navegador
  fala só com servidor `127.0.0.1`, que aceita exclusivamente
  `otimizador_regua_v1` e `otimizador_carta_v1`;
...
- [x] botão de paridade compara a equação legível ao cálculo inline; POST, lote,
  fila, escrita e Ímpetos condicionais permanecem recusados/desligados;
