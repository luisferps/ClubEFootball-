...
class InterfaceOtimizadorTest(unittest.TestCase):
    ...
    def test_executavel_portatil_mantem_o_estado_local_da_interface_v48(self):
        ...
        self.assertIn('ExpectedVersion = "\\\"versao_interface\\\": \\"20260901-v48\\\""', launcher)
        self.assertIn('AssemblyFileVersion("1.7.6.0")', launcher)
