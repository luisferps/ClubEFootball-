        ...
        try:
            ...
            return {
                **status,
                ...
                "pode_publicar": False,
                "origem": "clube_novo -> contrato V6 por ID -> worker local V3",
            }
        ...
        try:
            ...
            resposta = {
                **status, "ok": True, "itens": itens, "linha_atual": linha_atual,
                ...
                "totais": self._totais_fila(status),
                "publicacao": "SEM PUBLICAÇÃO", "pode_publicar": False,
                "origem": "clube_novo.otimizador_entrada_linha_v1 -> contratos V7 por ID -> worker local V3 -> Bonificador",
            }
