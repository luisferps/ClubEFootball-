...
class InterfaceOtimizadorTest(unittest.TestCase):
    ...
    def test_rotulos_continuam_resolvidos_por_ids_canonicos(self):
        ...
        self.assertIn("pedidoResultados=abaAtiva('resultados')", js)
    ...
    def test_executavel_portatil_mantem_o_estado_local_da_interface_v41(self):
        ...
        self.assertIn('ExpectedVersion = "\\\"versao_interface\\\": \\"20260831-v41\\\""', launcher)
        self.assertIn('AssemblyFileVersion("1.7.0.0")', launcher)
        self.assertIn('Local\\ClubEfootballOtimizadorLauncherV41', launcher)
