...
class InterfaceOtimizadorTest(unittest.TestCase):
    ...
    def test_executavel_portatil_mantem_o_estado_local_da_interface_v45(self):
        ...
        self.assertIn('ExpectedVersion = "\\\"versao_interface\\\": \\"20260901-v45\\\""', launcher)
    ...
    def test_painel_nao_esconde_falha_da_lista_ou_resultados_e_invalida_js_antigo(self):
        ...
        self.assertIn('/app.js?v=20260901-v45', index)
