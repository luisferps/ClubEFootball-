...
máquina. A primeira abertura em um novo computador pode pedir a configuração
local já autorizada daquele computador; essa configuração fica fora do Git e
nunca deve ser copiada para repositório. Depois disso, abrir o ícone não baixa
a fila novamente.
