...
class InterfaceOtimizadorTest(unittest.TestCase):
        ...
        class Gateway:
            ...
            def rpc(self, nome, corpo=None):
                ...
                if nome != "otimizador_producao_controlar_lote_v3":
                    raise AssertionError(nome)
                return {"contrato": "otimizador_fila_producao_v3"}
    ...
    def test_recupera_a_falha_pre_reserva_v19_somente_pelo_contrato_exato(self):
        ...
        self.assertEqual(retorno["estado_lote"], "rodando")
        self.assertEqual(chamadas, [
            ("preparador", "lote-v19", True), ("worker", "lote-v19", True),
        ])
        self.assertEqual(servico.gateway.chamadas, [(
    ...
    def test_executavel_portatil_mantem_o_estado_local_da_interface_v46(self):
        ...
        self.assertIn('ExpectedVersion = "\\\"versao_interface\\\": \\"20260901-v46\\\""', launcher)
        self.assertIn('AssemblyFileVersion("1.7.4.0")', launcher)
        self.assertIn('Local\\ClubEfootballOtimizadorLauncherV44', launcher)
    ...
    def test_painel_nao_esconde_falha_da_lista_ou_resultados_e_invalida_js_antigo(self):
        ...
        self.assertIn('/app.js?v=20260901-v46', index)
