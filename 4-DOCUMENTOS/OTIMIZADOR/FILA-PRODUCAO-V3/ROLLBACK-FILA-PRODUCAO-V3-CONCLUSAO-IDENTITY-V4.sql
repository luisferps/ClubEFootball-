-- Rollback V3.4: restaura a função anterior. Não remove dados já gravados.
-- Esta definição anterior é incompatível com GENERATED ALWAYS AS IDENTITY e
-- só existe para recuperação documental explícita.
