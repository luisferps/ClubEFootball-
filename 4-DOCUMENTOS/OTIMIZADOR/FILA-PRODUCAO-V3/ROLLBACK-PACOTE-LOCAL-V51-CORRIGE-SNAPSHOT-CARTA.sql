-- Rollback V51: restaura literalmente a função de cartas da V50.
-- Use apenas para voltar ao artefato anterior; a V50 contém o nome físico
-- incorreto e, por isso, a página de cartas volta a ser recusada.
