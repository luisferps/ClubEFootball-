-- V3.3 — corrige apenas o vínculo do lote na fotografia de carta.
...
-- A criação V3 original referia s_card.lote_id, coluna inexistente na tabela
-- temporária de cartas selecionadas. A função já recebe p_lote_id; é esse ID
-- canônico que deve ser gravado. Não altera fórmula, seleção, pesos ou saída.
...
begin
  ...
  select p_lote_id,s_card.card_id,s_card.overall,s_card.entrada_otimizador,
