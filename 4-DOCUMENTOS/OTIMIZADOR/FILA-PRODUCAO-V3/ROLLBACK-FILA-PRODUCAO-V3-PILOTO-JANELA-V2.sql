-- Rollback V3.2: restaura exatamente a janela V3.1 anterior.
...
-- A definição restaurada usa 20 candidatas por carta solicitada. Não remove
-- lote, linha, build ou evento já gravado.
