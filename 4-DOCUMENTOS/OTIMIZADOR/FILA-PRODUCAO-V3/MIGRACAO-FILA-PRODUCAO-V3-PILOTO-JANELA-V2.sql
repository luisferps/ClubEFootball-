-- V3.2 — janela de piloto compatível com o timeout do contrato, sem alteração de fórmula, pesos, regras
...
-- de aplicar p_limite_cards. A V3.1 usava 20 candidatas por carta e ainda
-- excedia o timeout REST. Para p_limite_cards > 0, a janela determinística é
-- agora a quantidade pedida mais duas sobras; para p_limite_cards = 0, o
