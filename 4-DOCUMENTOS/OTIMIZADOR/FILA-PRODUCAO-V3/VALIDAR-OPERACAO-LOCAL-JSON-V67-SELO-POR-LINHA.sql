-- Readback somente leitura da V67.
...
select
  ...
  bool_and(definicao like $$%e.evento = 'preparo_integral_concluido'%$$)
    as exige_preparo_historico_confirmado,
  bool_and(definicao like $$%e.detalhe->>'fingerprint' = v_lote_fingerprint_recebido%$$)
    as valida_fingerprint_no_historico,
  bool_and(comentario like 'V67:%') as comentario_v67,
