...
assert chamadas == ['bonificador_regua_v3', 'bonificador_contexto_fila_v6'], chamadas
print('LANCAMENTO_ISOLADO_OK pipeline=max_rodadas_1 regua_v3,contexto_v6 sem_pendencia=sucesso gravacao=nao')
"""
