...
class TravaFormulaMigracaoTest(unittest.TestCase):
    ...
    def test_equacao_servico_intacta(self):
        self._iguais(Path("6-AVALIADOR-NO-RAILWAY/avaliador.py"), [
