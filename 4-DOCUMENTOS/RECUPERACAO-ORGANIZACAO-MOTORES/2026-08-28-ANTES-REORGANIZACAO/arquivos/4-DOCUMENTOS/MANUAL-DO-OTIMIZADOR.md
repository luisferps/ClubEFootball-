...
|---|---|
| fórmula canônica e multiplicador | `2-MOTORES/equacao.py` |
| busca local do ótimo | `2-MOTORES/motor.py` |
| execução em lotes | `2-MOTORES/roda_lote_v6.py` |
...
RODAR-O-MOTOR.bat / RODAR-TUDO.bat
  -> roda_lote_v6.py -> fonte_unica.py -> RPCs otimizador_*_v1
