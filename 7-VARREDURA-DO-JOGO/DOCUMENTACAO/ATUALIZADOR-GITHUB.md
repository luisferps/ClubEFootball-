...
Em uma pasta original baixada como ZIP, o botão inicializa o repositório e materializa o primeiro commit remoto somente depois dessas mesmas proteções. O usuário decide quando compilar o EXE desktop com `COMPILAR-EXTRATOR-DESKTOP.cmd`.
