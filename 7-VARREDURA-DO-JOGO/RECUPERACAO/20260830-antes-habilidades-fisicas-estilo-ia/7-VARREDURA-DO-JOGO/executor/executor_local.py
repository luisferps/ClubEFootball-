...
def evaluate_sync_readiness(contract: dict[str, Any], family_states: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "result_return_enabled": structural_coverage_complete,
        ...
        "state": "review_required" if structural_coverage_complete and not approved_in_extractor else "ready_to_apply" if structural_coverage_complete else "incomplete",
        "reason": "pacote de revisão pronto na UI do Extrator" if structural_coverage_complete and not approved_in_extractor else "leitura integral e aprovação interna concluídas" if structural_coverage_complete else "cobertura integral não concluída por família",
    }
