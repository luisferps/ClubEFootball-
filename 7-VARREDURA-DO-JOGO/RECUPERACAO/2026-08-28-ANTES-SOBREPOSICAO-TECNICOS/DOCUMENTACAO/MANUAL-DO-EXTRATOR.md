...
Textos por entrada, catálogo nominal de estilos de IA, efeitos completos de ímpetos,
times/vínculos, POTW e habilidade extra de variação aparecem como
...
A fonte de textos é corretamente identificada como `dt261_bra`, mas a atualização por
entrada continua bloqueada enquanto o recorte canônico atual não fechar com o CPK.
...
integral aparecem como **Não suportada nesta atualização**. A aplicação de metadados
continua bloqueada até existir adaptador canônico específico; suportado para comparar
não significa autorizado a escrever.
...
- Técnicos são comparáveis para identidade, idade, nacionalidade, afinidade física,
  ...
  Link-up continua explicitamente adiado; textos por entrada, efeitos completos de
  ímpetos, times/vínculos, POTW,
