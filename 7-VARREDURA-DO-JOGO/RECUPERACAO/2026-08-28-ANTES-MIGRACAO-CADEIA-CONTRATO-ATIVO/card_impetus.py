...
def apply_canonical_slot_projection(rows: dict[str, dict[str, str]], connection: Any) -> dict[str, Any]:
...
def validate_physical_slot_projection(csv_text: str, connection: Any) -> dict[str, Any]:
    ...
    return {
        ...
        "source": {"file": "Player.bin", "slot_1": "bit308/w10", "slot_2": "bit288/w10"},
