...
(function installCore(global) {
  ...
  const CARD_DIMENSION_TYPES = Object.freeze([
    { tipo_carta_id: 'player_type_0_subtype_0', codigo_tipo_fisico: 0, marcador_subtipo: 0, usa_player_delete_list: false, chave_texto: 'Any1W:980', nome_exibicao: 'Normal', status_associacao: 'oficial_ancorado', tipo_provisorio: false },
    { tipo_carta_id: 'player_delete_list', codigo_tipo_fisico: 0, marcador_subtipo: 0, usa_player_delete_list: true, chave_texto: 'Any2W:923', nome_exibicao: 'Jogador indisponível', status_associacao: 'classificacao_operacional_usuario', tipo_provisorio: false },
    { tipo_carta_id: 'player_type_1_subtype_0', codigo_tipo_fisico: 1, marcador_subtipo: 0, usa_player_delete_list: false, chave_texto: 'Any1W:981', nome_exibicao: 'Lendário', status_associacao: 'oficial_ancorado', tipo_provisorio: false },
    { tipo_carta_id: 'player_type_3_subtype_0', codigo_tipo_fisico: 3, marcador_subtipo: 0, usa_player_delete_list: false, chave_texto: 'Any1W:982', nome_exibicao: 'Em destaque', status_associacao: 'oficial_ancorado', tipo_provisorio: false },
    { tipo_carta_id: 'player_type_3_subtype_1', codigo_tipo_fisico: 3, marcador_subtipo: 1, usa_player_delete_list: false, chave_texto: 'Any1W:983', nome_exibicao: 'Em evidência', status_associacao: 'oficial_ancorado', tipo_provisorio: false },
    ...
    { tipo_carta_id: 'player_type_5_subtype_0', codigo_tipo_fisico: 5, marcador_subtipo: 0, usa_player_delete_list: false, chave_texto: 'Any2W:360', nome_exibicao: 'Épico', status_associacao: 'oficial_ancorado', tipo_provisorio: false },
    { tipo_carta_id: 'player_type_5_subtype_1', codigo_tipo_fisico: 5, marcador_subtipo: 1, usa_player_delete_list: false, chave_texto: 'Any3W:423', nome_exibicao: 'Épico - Big Time', status_associacao: 'oficial_ancorado', tipo_provisorio: false },
    { tipo_carta_id: 'player_type_6_subtype_0', codigo_tipo_fisico: 6, marcador_subtipo: 0, usa_player_delete_list: false, chave_texto: 'Any2W:361', nome_exibicao: 'Distinguido', status_associacao: 'oficial_ancorado', tipo_provisorio: false },
    { tipo_carta_id: 'player_type_6_subtype_1', codigo_tipo_fisico: 6, marcador_subtipo: 1, usa_player_delete_list: false, chave_texto: 'Any3W:422', nome_exibicao: 'Distinguido - Show Time', status_associacao: 'oficial_ancorado', tipo_provisorio: false },
  ...
  function cardRelationSource(card) {
    const attributeNames = Object.keys(K.ABILITIES);
    const bodyNames = ['altura', ...BODY_FIELDS.map(([name]) => name)];
    return {
      contract: CARD_RELATIONS_CONTRACT_VERSION,
      card_id: String(card.card_id),
      atributos: attributeNames.map((physical_name, index) => ({ index, physical_name, bit: K.ABILITIES[physical_name], width: K.ABIL_WIDTH, value: card.attrs[physical_name] })),
      corpo: (card.corpo || []).map((value, index) => ({ index, physical_name: bodyNames[index] || null, value })),
      habilidades: (card.skills || []).map((nome_en, ordem) => ({ nome_en, bit: K.SKILL_BITS[nome_en], ordem })),
      estilos_ia: (card.ai_styles || []).map((nome_en) => ({ nome_en, bit: K.AI_PLAYING_STYLES[nome_en] })),
      posicoes: Object.entries(card.aptitudes || {}).map(([codigo_en, nivel_aptidao]) => ({ codigo_en, bit: K.POSITION_APTITUDE_BITS[codigo_en], width: K.APTITUDE_WIDTH, nivel_aptidao }))
    };
  }
