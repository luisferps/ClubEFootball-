...
(async () => {
  ...
  assert(tecnicos.blocked_fields.link_up && tecnicos.blocked_fields.sobreposicao, 'campos ainda sem prova não permaneceram bloqueados');
  console.log('OK: 1478 técnicos; Capello u64 + 5 proficiências + 2 boosts; Link-up/Sobreposição bloqueados');
})().catch((error) => {
