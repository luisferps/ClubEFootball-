...
def run() -> None:
    ...
    required_launcher_fragments = (
        ...
        "ProtectedData.Protect(clear, CredentialEntropy, DataProtectionScope.CurrentUser)",
        "ProtectedData.Unprotect(encrypted, CredentialEntropy, DataProtectionScope.CurrentUser)",
