  ...
  function coverageBlockedCatalogsFromContract(){
    ...
    for(const mapping of plan?.catalogos_fisicos||[]){
      ...
      output[key]={
        ...
        declared_coverage_state:mapping.estado_cobertura,
