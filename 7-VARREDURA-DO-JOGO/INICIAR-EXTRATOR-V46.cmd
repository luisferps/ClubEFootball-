...
echo.>>"%BOOTLOG%"
echo ============================================================>>"%BOOTLOG%"
echo [%date% %time%] INICIO - Extrator eFootball V4.6.7>>"%BOOTLOG%"
...
echo Preparando o Extrator eFootball V4.6.7...
...
echo [%date% %time%] OK - EXE V4.6.7 reconstruido; abrindo na porta exclusiva 8771>>"%BOOTLOG%"
