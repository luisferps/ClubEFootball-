...
[assembly: AssemblyDescription("Consulta e validação local, somente leitura, do Bonificador")]
...
namespace ClubEfootballBonificador
{
    ...
    {
        private const string AppUrl = "http://127.0.0.1:8766/";
        private const string StatusUrl = "http://127.0.0.1:8766/api/saude";
        ...
        private static void Main()
        {
            ...
            {
                MessageBox.Show(
                    "Não foi possível abrir o Bonificador ClubEfootball.\n\n" + error.Message,
                    "Bonificador ClubEfootball", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private static void WaitForServer()
        {
            ...
            throw new InvalidOperationException("O executor local do Bonificador não respondeu. A instalação pode estar incompleta.");
        }
        ...
        private static void StartHiddenExecutor(string root)
        {
            ...
            server.EnvironmentVariables["CLUBEF_BONIFICADOR_PORT"] = "8766";
