-- Ficha: separa nome do campo e rotulo do valor do pe. Preserva valores e bonus.
SET lock_timeout='3s';
...
RETURNS jsonb LANGUAGE plpgsql STABLE SECURITY DEFINER SET search_path TO '' SET jit TO off
AS $function$
declare
  ficha jsonb;
  impetos jsonb;
