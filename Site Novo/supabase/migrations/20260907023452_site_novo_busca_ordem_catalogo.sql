-- Dentro do mesmo tipo de correspondência, o maior overall vem primeiro; boxes inválidas não são exibidas.
...
begin
  ...
  ordenada as materialized (
    select b.*, row_number() over (
      order by b.prioridade, b.overall desc nulls last, b.relevancia desc,
...
is 'Busca publica do Site Novo sobre carta_jogo. Prioriza nome, depois overall e relevancia; omite rotulos de box invalidos.';
