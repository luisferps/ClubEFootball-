drop function if exists public.site_novo_busca_v1(text, integer, integer);

create function public.site_novo_busca_v1(
  p_busca text,
...
begin
  ...
  select jsonb_build_object(
    ...
    'itens', coalesce((select jsonb_agg(jsonb_build_object(
      ...
      'overall', overall, 'pontuacao_total', pontuacao_total,
      'posicao', posicao, 'posicao_nome', posicao_nome,
