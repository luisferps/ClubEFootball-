create or replace function public.site_novo_ficha_v1(
  p_card_id text default null,
  p_linha_id bigint default null
)
returns jsonb
language sql
stable
...
comment on function public.site_novo_ficha_v1(text, bigint) is
  'Site Novo: porta publica de leitura da Ficha v1. Retorna um DTO JSONB inteiro por card/linha publicada, sem expor tabelas e sem recalcular nota.';

revoke all on function public.site_novo_ficha_v1(text, bigint) from public;
grant execute on function public.site_novo_ficha_v1(text, bigint)
